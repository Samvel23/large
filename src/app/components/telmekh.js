        ...
        <div className="container">
          <div className="columns is-vcentered is-multiline">
            ...
            <div className="column is-6 fade-in-right">
              <h1 className="title is-2 gradient-text mb-4">
                TelMekh
              </h1>
              ...
              <ul className="content is-size-5 list-animate">
                <li>{lang === "eng" ? "Handmade from quality wood" : lang === "ru" ? "Изготовлено вручную из качественной древесины." : "Ձեռագործ՝ որակյալ փայտից"}</li>
              </ul>
